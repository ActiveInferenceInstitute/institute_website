...
| **all other tracked root dirs** — `about/`, `active-inference/`, `active-inference-and-*/`, `activities/`, `board-of-directors/`, `calendar/`, `directory/`, `ecosystem/`, `eduactive/`, `get-involved/`, `grants/`, `history/`, `instituteos/`, `knowledge/`, `learning/`, `measure/`, `officers/`, `prepare/`, `programs/`, `projects/`, `reinference/`, `resources/`, `scientific-advisory-board/`, `search/`, `simulations/`, `sitemap/`, `strategy/`, `structure/`, `video/`, `volunteer/`, `weekly/`, `2025/`, `2026/`, and locales `ar/ de/ es/ fr/ hi/ it/ ja/ ko/ pt/ ru/ zh/` | OUTPUT | **never** | **Generated, tracked HTML — regenerate via `node src/build.mjs`** |
