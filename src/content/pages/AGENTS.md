...
| `domains/` | "Active Inference and X" domain-knowledge pages (`active-inference-and-*`). Generated by the InstituteOS exporter (`OutputTarget.PAGES_DOMAINS`). Flat slugs map to `/active-inference-and-<domain>/`; folder placement is organizational only. |
