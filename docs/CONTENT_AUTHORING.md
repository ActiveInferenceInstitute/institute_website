...
| `pages/domains/` | "Active Inference and X" domain-knowledge pages (`active-inference-and-*`), generated by the InstituteOS exporter. Flat slugs — folder placement adds no URL prefix. |
